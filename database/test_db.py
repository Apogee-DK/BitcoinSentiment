...
# write to db
for ww in weightedWords:
    pos = weightedWords[ww]['pos']
    neut = weightedWords[ww]['neut']
    neg = weightedWords[ww]['neg']
    firebase.put('https://bitcoinsentiment.firebaseio.com/' + ww, {'pos': pos, 'neut': neut, 'neg': neg})
